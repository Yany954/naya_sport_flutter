        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              TextFieldContainer( // Usa el widget TextFieldContainer
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        enabledBorder: UnderlineInputBorder( // Cambia el color de la línea debajo del texto
                          borderSide: BorderSide(color: Colors.grey), // Especifica el color blanco
                        ),
                      ),
                    ),
                    TextField(
                ...
                onPressed: () async {
                  ...
                  if (result == 200) {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (context) => const NayaSportStore()),
                    );
                  } else {
